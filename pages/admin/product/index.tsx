...
const ProductAdminPage: FC = () => {
  ...
  const [product, getProduct, isNew] = useProduct(
    `${process.env.NEXT_PUBLIC_BACKEND_URL}/product/${router.query.slug}`,
    router.query.slug
  );
  ...
  useEffect(() => {
   /*  if (product._id) {
    ...
    setValue("inStock", product.inStock, { shouldValidate: true });
    
    /* const currentTags = getValues("tags");
    currentTags.push('hola'); */
  }, [product,isNew]);
